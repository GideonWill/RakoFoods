    ...
    <div className="pt-16">
      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            ref={storyRef}
            className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center transform transition-all duration-700 ${storyInView ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'
              }`}
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <TeamMemberCard
              ...
              name="Baaba"
              role="Assistant"
              bio="The backbone of daily operations at RAKO Foods, Baaba ensures the perfect quality of our drinks and yoghurt products. Her attention to detail and dedication helps maintain our high standards."
              delay={150}
            />
            <TeamMemberCard
              ...
              name="Golden Boy"
              role="Organiser"
              bio="The creative force behind RAKO Foods' events and customer experiences. Golden Boy coordinates our product launches, tastings, and special promotions, bringing energy and flair to everything we do."
              delay={300}
            />
          </div>
        </div>
