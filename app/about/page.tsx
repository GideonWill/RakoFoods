          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                ...
                intake of overly processed imported beverages. What started as a
                small venture during her first degree—selling a single drink,
                sobolo, at her hostel—has grown significantly. Today, we offer a
                variety of products, including fruit juices, yogurt, and other
                local drinks. Additionally, we prepare bulk homemade meals for
                busy individuals who want to enjoy traditional dishes without
                the hassle of cooking. We firmly believe that food plays a vital
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 text-sm">
                  A visionary leader and a health-conscious entrepreneur,
                  specialized in producing nutritious drinks made from herbs,
                  fruits, grains, and dairy. Committed to sustainability and
                  natural ingredients, the brand aims to promote healthier
                  lifestyles through innovative beverage solutions.
                </p>
              </div>
            </div>
